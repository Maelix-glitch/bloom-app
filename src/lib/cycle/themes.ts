...
export const CYCLE_THEMES: CycleTheme[] = [
  {
    id: "nocturne",
    name: "Nocturne",
    tagline: "Ink-plum ground, amethyst and champagne",
    description:
      "The default. A near-black ground with a violet bias, hairline-bordered cards, a rose bleed phase and champagne ovulation. Calm, editorial, and easy on the eyes at night — which is when most people check.",
    palette: [
      { label: "Ground", hex: "#0d0b12" },
      { label: "Surface", hex: "#16131e" },
      { label: "Ink", hex: "#f2ecec" },
      { label: "Menstrual", hex: "#cf6d8f" },
      { label: "Follicular", hex: "#a58bff" },
      { label: "Ovulation", hex: "#e3c187" },
      { label: "Luteal", hex: "#8b74c9" },
    ],
  ...
  },
  {
    ...
    palette: [
      ...
      { label: "Follicular", hex: "#7fb8a6" },
      { label: "Ovulation", hex: "#dfb35c" },
      { label: "Luteal", hex: "#5f8f9d" },
    ],
  ...
  },
  {
    id: "aurora",
    name: "Aurora",
    tagline: "Deep teal-indigo, glass panels, drifting light",
    description:
      "The most atmospheric direction: three blurred orbs drift behind translucent, blurred cards. Mint follicular, hot berry menstrual, saffron ovulation on a deep teal-indigo ground.",
    palette: [
      { label: "Ground", hex: "#09131a" },
      { label: "Surface", hex: "#10222a" },
      { label: "Ink", hex: "#e8f6f4" },
      { label: "Menstrual", hex: "#e2578c" },
      { label: "Follicular", hex: "#45e0c0" },
      { label: "Ovulation", hex: "#ffd166" },
      { label: "Luteal", hex: "#2f9fbb" },
    ],
    traits: ["Glass + blur", "18px radius", "Drifting aurora", "Brightest accents"],
    best: "When you want the page to feel alive — the signature look.",
  },
  {
    id: "ember",
    name: "Ember",
    tagline: "Warm charcoal and candlelight",
    description:
      "The warmest of the dark directions: brown-black ground, amber glow, rose bleed phase and 22px geometry. Reads like a room lit by a lamp rather than a screen.",
    palette: [
      { label: "Ground", hex: "#14100e" },
      { label: "Surface", hex: "#1d1714" },
      { label: "Ink", hex: "#f6ece1" },
      { label: "Menstrual", hex: "#d05a6e" },
      { label: "Follicular", hex: "#4fae9b" },
      { label: "Ovulation", hex: "#f0a94c" },
      { label: "Luteal", hex: "#3a8c86" },
    ],
    traits: ["Warm glow", "22px radius", "Amber accents", "Heavy grain"],
    best: "Evening use, or if the cool directions feel clinical to you.",
  },
  {
    id: "ink",
    name: "Ink",
    tagline: "Near-black, bone white, nothing extra",
    description:
      "The stripped-back one: 6px corners, no shadows, no atmosphere, white as the accent. Type and data only — the closest thing to a printed page.",
    palette: [
      { label: "Ground", hex: "#0a0a0b" },
      { label: "Surface", hex: "#111113" },
      { label: "Ink", hex: "#f4f4f1" },
      { label: "Menstrual", hex: "#e35d84" },
      { label: "Follicular", hex: "#7fd1c3" },
      { label: "Ovulation", hex: "#f2c46b" },
      { label: "Luteal", hex: "#4fa3ae" },
    ],
    traits: ["No shadows", "6px radius", "White accent", "Flat black"],
    best: "When content density wins — the most legible of the eight.",
  },
  {
    id: "daybreak",
    name: "Daybreak",
