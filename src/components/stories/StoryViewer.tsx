      ...
      <DialogPrimitive.Portal>
        ...
        >
          ...
          <div
            ...
            tabIndex={-1}
            data-story-frame=""
            className="relative flex h-full w-full max-w-[460px] flex-col overflow-hidden outline-none transition-[transform,opacity] duration-200 data-[state=closed]:opacity-0 sm:h-[min(92vh,860px)] sm:rounded-xl sm:border sm:border-border"
            style={{
              background:
